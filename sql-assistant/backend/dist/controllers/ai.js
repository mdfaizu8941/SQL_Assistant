...
exports.executeQuery = exports.validateQuery = exports.explainQuery = exports.generateQuery = exports.classifyQueryRisk = void 0;
...
const fetchSchemaString = async (dbConfig) => {
...
${schemaStr}`;
        ...
        const risk = await (0, exports.classifyQueryRisk)(generatedSql);
